...
*******************************************************************/ 
    ...
    vEnc_1(DEFAULT_BITRATE, 5, H264_ULTRAFAST, H264_DEFAULT_PROFILE, H264_ZEROLATENCY, "Cam1-Encoder-HQ");

    FFMPEGH264Encoder <YUV420_PLANAR, WIDTH_2, HEIGHT_2>
    vEnc_2(DEFAULT_BITRATE, 5, H264_ULTRAFAST, H264_DEFAULT_PROFILE, H264_ZEROLATENCY, "Cam1-Encoder-LQ");
