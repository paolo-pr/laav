...
* Error/exception handling must be less generic and will be developed/improved ASAP (according to my spare time, which is never enough...). A doc/example of how to manage errors will be added as well.
